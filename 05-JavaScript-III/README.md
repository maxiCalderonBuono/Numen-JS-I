...
# Javascript III (continuación de bucles `for` y Arrays)
...
console.log(nombresEstudiantes[1]);  // 'Fernando'
```
...
console.log(nombresEstudiantes);  // ['Jorge', 'Fernando', 'Sara', 'Samuel']
```
### `.push` y `.pop`
...
console.log(nombresEstudiantes);  // ['Martin', 'Fernando', 'Sara', 'Samuel', 'Patricia']
```
...
console.log(nombresEstudiantes);  // ['Martin', 'Fernando', 'Sara']
```
...
console.log(nombresEstudiantes);  // ['Leo', 'Martin', 'Fernando', 'Sara', 'Samuel']
